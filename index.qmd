...
# lubridate::isoweek(as.Date("13-09-2021", format = "%d-%m-%Y"))
DT::datatable(schedule[ordr, ], rownames = FALSE, options = list(pageLength = nrow(schedule)))
```
...
7. Inside this folder is a shortcut titled `Launch_book.html`. Double-clicking this should launch the book in your browser.
    + If this doesn't work: The target of the shortcut is the file `index.html` in the `docs` folder, which you can also open directly!
...
b.	Perform some kind of data reduction analysis (200 words)
    i. Report and interpret the results
b.	Perform reliability analysis (200 words)
    i. Report and interpret the results
b.	Construct a model with only main effects (200 words)
    i. Report and interpret the results
c.	Construct a model with the interaction effect (200 words)
...
b.	Include a continuous control variable in one of the preceding models (200 words)
    i. Report and interpret the results
e.	Discuss your analyses (300 words)
    i. Explain your rationale for important modeling decisions
    ii.	Motivate your choice for the type of statistics and analyses
