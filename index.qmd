...
Note that the assignments are **not** full-length papers!
There is a stated word limit for each section.
...
The focus should be on motivating, reporting, interpreting, and discussing your analyses.
For each analysis, state beforehand what your research question and hypotheses are.
