...
Note that figure a shows such a linear pattern of association;
the correlation coefficient of $r = .82$ tells us that there is a strong - but not perfect - positive association.

Figure b, on the other hand, shows a *perfect non-linear* association.
...
For example, if you were to examine the pattern in figure b for values of X between [4, 9], you would conclude that $r = 0.99$, or near perfect positive correlation.
...
The figures below split up the pattern from figure b above into these three segments:
...
For example, if your sample only consists of university students, you will probably havce restriction of range on IQ.
