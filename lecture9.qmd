...
* In this context, B is a **confounder**
    + A confounder can create a spurious association, or distort a true causal relationship between A and C
* Identifying and controlling for confounders is integral to causal inference
