...
What proportion of the variance Emotional Pleasure (scpleasure) is explained by our single predictor Variety at work (scvariety)? `r fitb(.195, num = T, tol = .01)`
...
What is the value of the regression coefficient of scpleasure on scvariety (b1)? `r fitb(.618, num = T, tol = .01)`
