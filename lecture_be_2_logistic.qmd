...
How well does the model predict true positives / true negatives?
...
3. Cross-tabulate the observed outcome $Y_i$ against the dichotom
4. How accurate are the predictions? Where do we see most prediction errors?
