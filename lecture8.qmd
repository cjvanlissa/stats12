...
* It provides an omnibus test of differences between group means
...
$$
F = \frac{MS_B}{MS_W} = \frac{SSB / df_b}{SSW/df_w}
$$
...
Sum  | Formula                         | Meaning
-----|---------------------------------|---------------
SST  | $\sum{(Y_i - \bar{Y})^2}$       | Variation of individuals wrt grand mean
