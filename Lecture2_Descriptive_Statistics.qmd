...
|---------------------------------------------|---------------------------|----------------------------|
| Add $k = 2$ to every score                  | 6, 8, 9, 5, 12            | $6 + 2 = 8$                |
| Multiply every score by $c = 3$             | 12, 18, 21, 9, 30         | $6 \times 3 = 18$          |
| Change one score by $\Delta = +3$ (10: 13) | 4, 6, 7, 3, 13            | $6 + \tfrac{3}{5} = 6.6$   |
