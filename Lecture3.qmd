...
* This applies to other statistics than means too
...
![](images/Lecture 313.png)

  * Weekly fruit consumption \(i\.e\.\, pieces of fruit\) is normally distributed with mean 10\.5 and an SD of 6\.4\. What is the probability that the  _mean_  fruit consumption of 16 randomly chosen persons is less than 7\.78?
...
<!-- Significance \(α\) level: we reject H0 if our sample is among the 5% of the samples in the tails -->
