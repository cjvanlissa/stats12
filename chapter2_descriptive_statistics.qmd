...
```{r figecwagenmakers, fig.cap="An interpretation of De Groot’s empirical cycle, by Wagenmakers, Dutilh, & Sarafoglou, 2018. CC-BY: Artwork by Viktor Beekman, concept by Eric-Jan Wagenmakers"}
knitr::include_graphics("creativity_verification.jpg")
```
...
## Statistical Models in Descriptive Statistics {#sec-model}

Descriptive statistics also present the first example of a *statistical model*.
